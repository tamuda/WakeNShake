    ...
    >
      <Container>
        ...
        <p className="mt-4 max-w-xl text-lg tracking-tight text-slate-600">
          “WakeNShake" is available in two different packages so you can pick
      ...
      <div className="mx-auto mt-16 max-w-5xl lg:px-6">
        <div className="grid bg-slate-50 sm:px-6 sm:pb-16 md:grid-cols-2 md:rounded-6xl md:px-8 md:pt-16 lg:p-20">
          <Plan
            name="Basic"
            description="Get started with our WakeNShake device and experience the benefits of waking up naturally."
            price={25}
            href="#"
            features={[
              'One WakeNShake device',
          ...
          <Plan
            featured
            name="Premium"
            description="Upgrade your WakeNShake experience with additional features and capabilities."
            price={45}
            href="#"
            features={[
              'Two WakeNShake devices',
              'Adjustable vibration intensity',
              'Easy-to-use interface',
